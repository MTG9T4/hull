...
class Recorder:
    ...
    def register_replay_callback(self, action_type: str, callback: Callable):
        """
        Register a callback for replaying specific maneuver types

        Args:
            action_type: Type of maneuver to handle
            callback: Function to call for this maneuver type
        """
    ...
    async def replay_episode(
        ...
        for step in episode.steps:
            ...
            action_type = step["maneuver"]["type"]
            ...
            if action_type in self.replay_callbacks:
                ...
                try:
                    # Recreate maneuver
                    action_params = step["maneuver"].get("params", {})
                    recreated_action = maneuver(action_type, **action_params)
