"""
Generic planner for generating maneuver sequences
"""
...
class NavigatorBase(ABC):
    """Abstract base class for navigators."""
...
class Navigator:
    """Route-planner for pilots. Register strategies to chart a course through any task."""
    ...
    def register_strategy(
        ...
        Args:
            ...
            strategy: Callable that takes (goal, state, context) and returns List[Maneuver]
    ...
    def validate_plan(
        self, plan: list[Maneuver], validator: Callable | None = None
    ) -> tuple[bool, str | None]:
        """
        Validate a plan
        ...
        for maneuver in plan:
            if not maneuver.type:
                return False, "Maneuver missing type"

        return True, None

    def merge_plans(
        self, plans: list[list[Maneuver]], merger: Callable | None = None
    ) -> list[Maneuver]:
        """
    ...
    def optimize_plan(
        self, plan: list[Maneuver], optimizer: Callable | None = None
    ) -> list[Maneuver]:
        """
        Optimize a plan
